...
- Glaze UI 1.0 conformance covers authentication, account, administration, onboarding/enrollment, recovery, settings, error, loading, empty, denied-access, warning, notification, and other controlled surfaces.
- Light and dark appearance are visually accepted.
