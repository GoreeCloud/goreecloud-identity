"""Native GoreeCloud Identity service credentials for GoreeCloud Mesh.

This module implements the ``goreecloud-identity.mesh-service-token.v1``
contract as a first-party GoreeCloud Identity authority. Private signing keys
remain in Identity; consumers receive only short-lived RS256 JWTs and public
JWKS material.

Transitional Authentik integration may call this module, but it does not own the
credential semantics or key lifecycle contract.
"""
